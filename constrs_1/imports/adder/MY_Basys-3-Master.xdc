...
# set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { led  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
# set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { sum[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
# set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { sum[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
# set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { sum[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
# set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { sum[4]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
# set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { sum[5]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
# set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { sum[6]  }]; #IO_25_14                     ,Sch=LED6
# set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { sum[7]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
# set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { carry  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
